                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'discount_percent'])
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    ...
                                    @endcan
                                    @can('discount_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $discount->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
