<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('user.telephone') ? 'invalid' : '' }}">
        <label class="form-label required" for="telephone">{{ trans('cruds.user.fields.telephone') }}</label>
        <input class="form-control" type="text" name="telephone" id="telephone" required wire:model.defer="user.telephone">
        <div class="validation-message">
