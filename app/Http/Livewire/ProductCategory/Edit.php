...
class Edit extends Component
{
    ...
    public function mount(ProductCategory $productCategory)
    {
        ...
        $this->mediaCollections = [
            'product_category_category_image' => $productCategory->category_image,
        ];
    }
    ...
    protected function rules(): array
    {
        return [
            ...
            'mediaCollections.product_category_category_image' => [
                'array',
                'required',
            ],
            'mediaCollections.product_category_category_image.*.id' => [
                'integer',
                'exists:media,id',
            ],
        ];
